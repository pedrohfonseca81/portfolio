defmodule PedrofonsecadevWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PedrofonsecadevWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PedrofonsecadevWeb.Gettext, "errors", msg, opts)
    end
  end
